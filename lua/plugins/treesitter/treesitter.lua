  ...
  opts = {
    ...
    indent = { enable = true },
      ...
      ensure_installed = {
        ...
        'json', 'jsonc', 'json5',  'jsonnet', 'julia', 'kconfig', 'latex',
        'make', 'markdown', 'markdown_inline', 'matlab', 'mermaid', 'ninja',
        'objc', 'pascal', 'passwd', 'pem', 'perl', 'php', 'phpdoc', 'psv',
        'purescript', 'r', 'regex', 'ruby', 'rust', 'scala', 'scheme',
        'sql', 'ssh_config', 'swift', 'systemtap', 'todotxt', 'tsv', 'tsx',
