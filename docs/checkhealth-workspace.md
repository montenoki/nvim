...
conform.nvim report ~
- Log file: /tmp/nvim-health-workspace-state/nvim/conform.log
...
- Expected location: `/tmp/nvim-health-workspace-config/github-copilot/auth.db`
...
- LSP log level : WARN
- Log path: /tmp/nvim-health-workspace-state/nvim/lsp.log
- Log size: 0 KB
...
- Lockfile: /tmp/nvim-health-workspace-config/nvim/nvim-pack-lock.json
...
- ⚠️ WARNING In mode `n`, <g> overlaps with <gc>, <gcc>, <gcO>, <gco>, <g%>, <gP>, <gp>, <g_>, <gzh>, <gzr>, <gzn>, <gzf>, <gzd>, <gzF>, <gza>, <gra>, <grn>, <grx>, <gri>, <grr>, <grt>, <g[>, <g]>, <gs>, <gx>, <gO>:
  - <g>: goto
  - <gc>: Toggle comment
