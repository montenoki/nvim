# checkhealth 复查：当前部署的 parser 路径

日期：2026-09-12。使用 `nvim-test` 和配置提交 `2c0e101`，其余检查方式与
[上一轮报告](checkhealth-recheck.md) 相同。

NixOS 提交 `a7dc107` 已加入 latex parser、pylatexenc、ast-grep。
当前 Home Manager 的 `hm-session-vars.sh` 声明
`NVIM_NIX_PARSER_RTP=/nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime`。
上一轮检查继承旧会话中的 `6zfg8cnr4kafdyjyczlpa58f533y76g9` runtime，导致 latex parser 缺失提示。
本轮按当前部署值显式设置变量后重新运行完整检查，没有修改 Nix 配置。

LaTeX parser installed、ABI 15、latex2text 均为 OK，H10–H12 已通过。

本次共 **42 条诊断：8 ERROR、34 WARNING**。
...
- ✅ OK Available Treesitter languages:
    `html`, `javascript`, `latex`, `markdown_inline`, `markdown`, `tsx`
- ⚠️ WARNING Missing Treesitter languages:
    `css`, `norg`, `scss`, `svelte`, `typst`, `vue`
...
Treesitter parsers ~
- ✅ OK Parser: bash                      ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/bash.so
- ✅ OK Parser: c                         ABI: 15, path: /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/lib/nvim/parser/c.so
- ✅ OK Parser: c                    (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/c.so
- ✅ OK Parser: diff                      ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/diff.so
- ✅ OK Parser: dockerfile                ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/dockerfile.so
- ✅ OK Parser: dtd                       ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/dtd.so
- ✅ OK Parser: git_config                ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/git_config.so
- ✅ OK Parser: git_rebase                ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/git_rebase.so
- ✅ OK Parser: gitattributes             ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/gitattributes.so
- ✅ OK Parser: gitcommit                 ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/gitcommit.so
- ✅ OK Parser: gitignore                 ABI: 13, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/gitignore.so
- ✅ OK Parser: hcl                       ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/hcl.so
- ✅ OK Parser: html                      ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/html.so
- ✅ OK Parser: javascript                ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/javascript.so
- ✅ OK Parser: jsdoc                     ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/jsdoc.so
- ✅ OK Parser: json                      ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/json.so
- ✅ OK Parser: latex                     ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/latex.so
- ✅ OK Parser: lua                       ABI: 15, path: /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/lib/nvim/parser/lua.so
- ✅ OK Parser: lua                  (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/lua.so
- ✅ OK Parser: luadoc                    ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/luadoc.so
- ✅ OK Parser: luap                      ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/luap.so
...
- ✅ OK Parser: markdown             (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/markdown.so
...
- ✅ OK Parser: markdown_inline      (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/markdown_inline.so
- ✅ OK Parser: ninja                     ABI: 13, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/ninja.so
- ✅ OK Parser: nix                       ABI: 13, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/nix.so
- ✅ OK Parser: printf                    ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/printf.so
- ✅ OK Parser: python                    ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/python.so
- ✅ OK Parser: query                     ABI: 15, path: /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/lib/nvim/parser/query.so
- ✅ OK Parser: query                (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/query.so
- ✅ OK Parser: regex                     ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/regex.so
- ✅ OK Parser: ron                       ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/ron.so
- ✅ OK Parser: rst                       ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/rst.so
- ✅ OK Parser: rust                      ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/rust.so
- ✅ OK Parser: sql                       ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/sql.so
- ✅ OK Parser: terraform                 ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/terraform.so
- ✅ OK Parser: toml                      ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/toml.so
- ✅ OK Parser: tsx                       ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/tsx.so
- ✅ OK Parser: typescript                ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/typescript.so
- ✅ OK Parser: vim                       ABI: 15, path: /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/lib/nvim/parser/vim.so
- ✅ OK Parser: vim                  (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/vim.so
...
- ✅ OK Parser: vimdoc               (not loaded), path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/vimdoc.so
- ✅ OK Parser: xml                       ABI: 14, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/xml.so
- ✅ OK Parser: yaml                      ABI: 15, path: /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/parser/yaml.so
...
- ✅ OK bash            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/bash
- ✅ OK bash            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/bash
- ✅ OK bash            indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/bash
- ✅ OK bash            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/bash
- ✅ OK bash            locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/bash
...
- ✅ OK c               folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/c
- ✅ OK c               highlights      /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/share/nvim/runtime/queries/c
- ✅ OK c               highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/c
- ✅ OK c               indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/c
- ✅ OK c               injections      /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/share/nvim/runtime/queries/c
- ✅ OK c               injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/c
- ✅ OK c               locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/c
...
- ✅ OK diff            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/diff
- ✅ OK diff            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/diff
- ✅ OK diff            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/diff
- ✅ OK dockerfile      highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/dockerfile
- ✅ OK dockerfile      injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/dockerfile
- ✅ OK dockerfile      textobjects     /home/ten/.local/share/nvim-test/lazy/nvim-treesitter-textobjects/queries/dockerfile
- ✅ OK dtd             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/dtd
- ✅ OK dtd             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/dtd
- ✅ OK dtd             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/dtd
- ✅ OK dtd             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/dtd
...
- ✅ OK git_config      folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/git_config
- ✅ OK git_config      highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/git_config
- ✅ OK git_config      injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/git_config
- ✅ OK git_config      textobjects     /home/ten/.local/share/nvim-test/lazy/nvim-treesitter-textobjects/queries/git_config
- ✅ OK git_rebase      highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/git_rebase
- ✅ OK git_rebase      injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/git_rebase
- ✅ OK gitattributes   highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitattributes
- ✅ OK gitattributes   injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitattributes
- ✅ OK gitattributes   locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitattributes
- ✅ OK gitcommit       highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitcommit
- ✅ OK gitcommit       injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitcommit
- ✅ OK gitignore       highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitignore
- ✅ OK gitignore       injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/gitignore
...
- ✅ OK hcl             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/hcl
- ✅ OK hcl             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/hcl
- ✅ OK hcl             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/hcl
- ✅ OK hcl             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/hcl
...
- ✅ OK html            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/html
- ✅ OK html            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/html
- ✅ OK html            images          /home/ten/.local/share/nvim-test/lazy/snacks.nvim/queries/html
- ✅ OK html            indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/html
- ✅ OK html            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/html
- ✅ OK html            locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/html
...
- ✅ OK javascript      folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/javascript
- ✅ OK javascript      highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/javascript
- ✅ OK javascript      images          /home/ten/.local/share/nvim-test/lazy/snacks.nvim/queries/javascript
- ✅ OK javascript      indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/javascript
- ✅ OK javascript      injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/javascript
- ✅ OK javascript      locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/javascript
- ✅ OK javascript      textobjects     /home/ten/.local/share/nvim-test/lazy/nvim-treesitter-textobjects/queries/javascript
- ✅ OK jsdoc           highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/jsdoc
- ✅ OK json            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/json
- ✅ OK json            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/json
- ✅ OK json            indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/json
- ✅ OK json            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/json
- ✅ OK json            locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/json
...
- ✅ OK latex           folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/latex
- ✅ OK latex           highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/latex
- ✅ OK latex           images          /home/ten/.local/share/nvim-test/lazy/snacks.nvim/queries/latex
- ✅ OK latex           injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/latex
...
- ✅ OK lua             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/lua
...
- ✅ OK lua             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/lua
- ✅ OK lua             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/lua
...
- ✅ OK lua             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/lua
- ✅ OK lua             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/lua
- ✅ OK lua             textobjects     /home/ten/.local/share/nvim-test/lazy/nvim-treesitter-textobjects/queries/lua
- ✅ OK luadoc          highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/luadoc
- ✅ OK luap            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/luap
- ✅ OK markdown        folds           /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/share/nvim/runtime/queries/markdown
- ✅ OK markdown        folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/markdown
...
- ✅ OK markdown        highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/markdown
- ✅ OK markdown        images          /home/ten/.local/share/nvim-test/lazy/snacks.nvim/queries/markdown
- ✅ OK markdown        indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/markdown
...
- ✅ OK markdown        injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/markdown
...
- ✅ OK markdown_inline highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/markdown_inline
...
- ✅ OK markdown_inline injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/markdown_inline
...
- ✅ OK ninja           folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ninja
- ✅ OK ninja           highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ninja
- ✅ OK ninja           indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ninja
- ✅ OK ninja           injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ninja
- ✅ OK nix             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/nix
- ✅ OK nix             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/nix
- ✅ OK nix             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/nix
- ✅ OK nix             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/nix
- ✅ OK nix             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/nix
...
- ✅ OK printf          highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/printf
- ✅ OK python          folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/python
- ✅ OK python          highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/python
- ✅ OK python          indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/python
- ✅ OK python          injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/python
- ✅ OK python          locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/python
...
- ✅ OK query           folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/query
- ✅ OK query           highlights      /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/share/nvim/runtime/queries/query
- ✅ OK query           highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/query
- ✅ OK query           indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/query
- ✅ OK query           injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/query
- ✅ OK query           locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/query
...
- ✅ OK regex           highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/regex
- ✅ OK ron             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ron
- ✅ OK ron             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ron
- ✅ OK ron             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ron
- ✅ OK ron             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ron
- ✅ OK ron             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/ron
- ✅ OK rst             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rst
- ✅ OK rst             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rst
- ✅ OK rst             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rst
...
- ✅ OK rust            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rust
- ✅ OK rust            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rust
- ✅ OK rust            indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rust
- ✅ OK rust            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rust
- ✅ OK rust            locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/rust
...
- ✅ OK sql             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/sql
- ✅ OK sql             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/sql
- ✅ OK sql             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/sql
- ✅ OK sql             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/sql
...
- ✅ OK terraform       folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/terraform
- ✅ OK terraform       highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/terraform
- ✅ OK terraform       indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/terraform
- ✅ OK terraform       injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/terraform
- ✅ OK terraform       textobjects     /home/ten/.local/share/nvim-test/lazy/nvim-treesitter-textobjects/queries/terraform
- ✅ OK toml            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/toml
- ✅ OK toml            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/toml
- ✅ OK toml            indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/toml
- ✅ OK toml            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/toml
- ✅ OK toml            locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/toml
- ✅ OK toml            textobjects     /home/ten/.local/share/nvim-test/lazy/nvim-treesitter-textobjects/queries/toml
- ✅ OK tsx             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/tsx
- ✅ OK tsx             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/tsx
- ✅ OK tsx             images          /home/ten/.local/share/nvim-test/lazy/snacks.nvim/queries/tsx
- ✅ OK tsx             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/tsx
- ✅ OK tsx             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/tsx
- ✅ OK tsx             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/tsx
...
- ✅ OK typescript      folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/typescript
- ✅ OK typescript      highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/typescript
- ✅ OK typescript      indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/typescript
- ✅ OK typescript      injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/typescript
- ✅ OK typescript      locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/typescript
...
- ✅ OK vim             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/vim
- ✅ OK vim             highlights      /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/share/nvim/runtime/queries/vim
- ✅ OK vim             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/vim
- ✅ OK vim             injections      /nix/store/hi8r0ag26xi8cfqp51yi18v85zi4xlr8-neovim-unwrapped-0.12.4/share/nvim/runtime/queries/vim
- ✅ OK vim             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/vim
- ✅ OK vim             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/vim
...
- ✅ OK vimdoc          highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/vimdoc
...
- ✅ OK vimdoc          injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/vimdoc
...
- ✅ OK xml             folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/xml
- ✅ OK xml             highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/xml
- ✅ OK xml             indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/xml
- ✅ OK xml             injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/xml
- ✅ OK xml             locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/xml
- ✅ OK yaml            folds           /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/yaml
- ✅ OK yaml            highlights      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/yaml
- ✅ OK yaml            indents         /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/yaml
- ✅ OK yaml            injections      /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/yaml
- ✅ OK yaml            locals          /nix/store/hsvk3kf55gkibnkcxsz8dnrs5qck431w-nvim-treesitter-runtime/queries/yaml
...
- ⚠️ WARNING In mode `n`, <g> overlaps with <gzf>, <gzd>, <gzh>, <gzr>, <gzF>, <gza>, <gzn>, <g_>, <g[>, <gx>, <gP>, <gp>, <gs>, <gri>, <grn>, <gra>, <grr>, <grt>, <grx>, <g%>, <g]>, <gc>, <gco>, <gcc>, <gcO>, <gO>:
  - <g>: goto
...
- ⚠️ WARNING In mode `x`, <a> overlaps with <ai>, <al>, <a%>, <an>:
  - <a>: around
  - <ai>: indent
  - <al>: last
  - <an>: next
- ⚠️ WARNING In mode `x`, <i> overlaps with <ii>, <il>, <in>:
  - <i>: inside
  - <ii>: indent
  - <il>: last
  - <in>: next
- ⚠️ WARNING In mode `o`, <a> overlaps with <ai>, <al>, <an>:
  - <a>: around
  - <ai>: indent
  - <al>: last
  - <an>: next
- ⚠️ WARNING In mode `o`, <i> overlaps with <ii>, <il>, <in>:
  - <i>: inside
  - <ii>: indent
  - <il>: last
  - <in>: next
